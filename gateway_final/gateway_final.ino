...
/*---------------- connected server ---------------------------*/
  if (client.connected()) {
    ...
    if(ctrl_bom=="on")temp2=1;else if(ctrl_bom=="off")temp2=2;
      json1["quat"]=ctrl_quat;
    if(ctrl_quat=="on")temp1=1;else if(ctrl_quat=="off")temp1=2;
      json1["phunsuong"]=ctrl_phunsuong;
    if(ctrl_phunsuong=="on")temp=1;else if(ctrl_phunsuong=="off")temp=2;
...
/*---------------- End connect server ---------------------------*/
  ...
  if(temp1==3)temp1=1;
  if(temp1==1)
  {ctrl_quat1="on";lcd.setCursor(3,0);
  lcd.print("ON" );}
  else if(temp1==2)
  {ctrl_quat1="off";lcd.setCursor(3,0);
  lcd.print("OFF" );}    
  }
  ...
  Serial.println("4");
   ...
   //dieukhien=!dieukhien;
       dieukhien=0; 
        ...
        StaticJsonBuffer<300> jsonBuff;
      JsonObject& json1 = jsonBuff.createObject();      
      json1["maybom"]=ctrl_bom1;
      json1["quat"]=ctrl_quat1;
      json1["phunsuong"]=ctrl_phunsuong1;
      json1.printTo(Serial);
      json1.prettyPrintTo(Serial);     
      json1.printTo(jsonstr1);
    ///////////////////////////////////////////////
  ...
  if(dieukhien==1){
    ...
    if (client.connected()) {
      ...
      jsonctrol["ctrl_quat"]=ctrl_quat1;
      jsonctrol["ctrl_bom"]=ctrl_bom1;
      jsonctrol["ctrl_phunsuong"]=ctrl_phunsuong1;
      jsonctrol["id"]="3";
